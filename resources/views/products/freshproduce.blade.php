...
@endif
<div class="card-body">
<table class="table table-bordered" id="freshproduce-datatable">
<thead>
<tr>
<th>Id</th>
<th>Name</th>
...
<div class="col-sm-12">
    ...
    <option value="8">Tomatoes</option>                
    </select>
</div>
</div> 
<div class="form-group">
...
$('#freshproduce-datatable').DataTable({
processing: true,
serverSide: true,
ajax: "{{ url('freshproduce-datatable') }}",
columns: [
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
...
dataType: 'json',
success: function(res){
var oTable = $('#freshproduce-datatable').dataTable();
oTable.fnDraw(false);
}
});
}
